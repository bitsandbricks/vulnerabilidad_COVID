...
Esta prueba de concepto toma a Bogotá, Colombia, como ubicación a analizar.
...
Descargamos los datos de [estimados demográficos para CoOlombia producidos por Facebook](https://data.humdata.org/dataset/colombia-high-resolution-population-density-maps-demographic-estimates)
...
```{r eval=FALSE}
url <- "https://data.humdata.org/dataset/2f865527-b7bf-466c-b620-c12b8d07a053/resource/3e871e9d-d9fa-4d52-af47-43cae54c7a6d/download/col_elderly_60_plus_2019-06-01_csv.zip"
...
```{r echo=FALSE}
#write_csv(personas_mayores, "~/Downloads/COL_elderly_60_plus_2019-06-01.csv")
personas_mayores <- read_csv("~/Downloads/COL_elderly_60_plus_2019-06-01.csv")
```
...
Nominatim es una base de datos global de nombres propios de lugares. Al realizarse una búsqueda, por ejemplo por "Bogotá", se encuentran distintas entidades geográficas con ese nombre. La interfaz de Nominatim permite comparar opciones y verificar los límites en el mapa, identificando la entidad buscada. 

En este caso, buscando por "Bogotá, Colombia", el resultado deseado es el primer resultado: _Bogota, Bogota Capital District, Colombia.

```{r out.width="800px", echo=FALSE}
knitr::include_graphics("img/nominatim_bogota.png")
```
...
```{r echo=FALSE}
st_write(celdas, "data/celdas_bogota.geojson")
```
